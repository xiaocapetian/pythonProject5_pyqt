...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.actionExit.triggered.connect(self.onExitTriggered)   #exit

        self.actionCopy.triggered.connect(self.onCopyTriggered)   #Copy
        self.actionPaste.triggered.connect(self.onPasteTriggered)  #Paste粘贴
        self.actionCut.triggered.connect(self.onCutTriggered)  #cut
        ...
        self.count = 0            #初始值为0
        self.timer.timeout.connect(self.showNum)       #槽函数showNum             信号timeout
